<template>
    <div>
        ...
        <div class="tile" v-if="attributeSelected">
            <h3 class="tile-title">Add Attributes To Package</h3>
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
            ...
            <div class="row" v-if="valueSelected">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <small class="text-danger">This price will be added to the main price of package on frontend.</small>
                    </div>
                </div>
                <div class="col-md-12">
                    <button class="btn btn-sm btn-primary" @click="addPackageAttribute()">
        ...
        <div class="tile">
            <h3 class="tile-title">Package Attributes</h3>
            <div class="tile-body">
                <div class="table-responsive">
                    <table class="table table-sm">
                        ...
                        <tbody>
                        <tr v-for="pa in packageAttributes" v-bind:key="pa.id">
                            ...
                            <td style="width: 25%" class="text-center">
                                <button class="btn btn-sm btn-danger" @click="deletePackageAttribute(pa)">
