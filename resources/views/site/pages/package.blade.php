          ...
          <div class="col-lg-10 col-md-12 col-lg-offset-1">
            <div class="ps-package__thumbnail">
              ...
              <div class="ps-package__image">
                <div class="item"><img id="potogede" class="zoom" src="{{ asset('storage/'.$package->images->first()->full) }}" alt="" data-zoom-image="{{ asset('storage/'.$package->images->first()->full) }} "></div>
                @else
            ...
            @if ($package->images->count() > 0)
              <div class="ps-package__main-img"><img id="potogede" src="{{ asset('storage/'.$package->images->first()->full) }}" alt=""></div>

              <div class="ps-package__preview owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="20" data-owl-nav="true" data-owl-dots="false" data-owl-item="3" data-owl-item-xs="3" data-owl-item-sm="3" data-owl-item-md="3" data-owl-item-lg="3" data-owl-duration="1000" data-owl-mousedrag="on">
                @foreach($package->images as $image)
            ...
            <div class="ps-package__info">
              ...
              <h3 class="ps-package__price">{{ config('settings.currency_symbol').$package->sale_price }}<del>{{ config('settings.currency_symbol').$package->price }}</del></h3>
              @else
              ...
              <div class="ps-package__block ps-package__size">
                ...
                @foreach($attributes as $attribute)
                                                  @php $attributeCheck = in_array($attribute->id, $package->attributes->pluck('attribute_id')->toArray()) @endphp
                                                      @if ($attributeCheck)
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="price" id="finalPrice" value="{{ $package->sale_price != '0' ? $package->sale_price : $package->price }}">
                </div>
              </div>
              <div class="ps-package__shopping"><button class="ps-btn mb-10" type="submit">Add to cart<i class="ps-icon-next"></i></button>
              </div>
              </form>
            </div>
