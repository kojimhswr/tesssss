(function ($) {
	...
	/*----------  Masonry Activation  ----------*/
		...
		var $masonry = $('.masonry-region-layout');
		var $grid = $('.grid-item');
		$grid.hide();
		...
		var $masonryCreativeHome = $('.masonry-region-layout--creativehome');
...
//	}
	...
	/*----------  sidebar region dropdown  ----------*/
	
	var sidebarCategoryParent = $('.single-filter-widget--list--region li.has-children, .single-sidebar-widget--list--region li.has-children');
