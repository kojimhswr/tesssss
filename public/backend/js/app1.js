...
function isStandardBrowserEnv() {
  if (typeof navigator !== 'undefined' && (navigator.package === 'ReactNative' ||
                                           navigator.package === 'NativeScript' ||
                                           navigator.package === 'NS')) {
    return false;
  }
  return (
    typeof window !== 'undefined' &&
  ...
  var runInContext = (function runInContext(context) {
    ...
    function template(string, options, guard) {
      ...
      string.replace(reDelimiters, function(match, escapeValue, interpolateValue, esTemplateValue, evaluateValue, offset) {
        ...
        // The JS engine embedded in Adobe packages needs `match` returned in
...
var config = ({
  ...
  /**
   * Show packageion mode tip message on boot?
   */
  ...
  setTimeout(function () {
    ...
    if (config.productionTip !== false &&
      ...
      console[console.info ? 'info' : 'log'](
        ...
        "Make sure to turn on packageion mode when deploying for packageion.\n" +
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\CRUISE\resources\js\app.js */"./resources/js/app.js");
